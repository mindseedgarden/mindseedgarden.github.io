...
for (const [from, to] of [['SEED.md', 'seed.md'], ['PRINCIPLES.md', 'principles.md'], ['PROTOCOL.md', 'protocol.md'], ['machine/seed.txt', 'seed.txt'], ['machine/principles.json', 'principles.json'], ['machine/protocol.md', 'protocol.md']]) {
...
const routes = ['', 'enter/', 'seed/', 'grove/', 'commons/', 'lineage/', 'laboratory/', 'archive/', 'about/', 'machine/'];
